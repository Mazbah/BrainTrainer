...
public class MainActivity extends AppCompatActivity {
    ...
    Button startButton;
    TextView pointsTextView,resultTextView,sumTextView,timerTextView;
    ...
    public void generateQuestion(){
        ...
        for(int i=0;i<4;i++){
            if(i == locationCorrectAnswers){
                ...
                incorrectanswers = rand.nextInt(51);
    ...
    public void chooseAnswer(View view){
        if(view.getTag().toString().equals(Integer.toString(locationCorrectAnswers))){
            score++;
